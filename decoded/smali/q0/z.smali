...
.method public static d()Ljava/util/Map;
    ...
    invoke-static {v0, v1}, La1/g;->c(Ljava/lang/Object;Ljava/lang/String;)V
...
.method public static final e(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_0
    invoke-static {p0}, Lq0/y;->c(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_1
    invoke-static {}, Lq0/w;->d()Ljava/util/Map;
...
.method public static g(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {v0}, Lq0/w;->a(I)I

    move-result v0

    invoke-direct {v1, v0}, Ljava/util/LinkedHashMap;-><init>(I)V

    invoke-static {p0, v1}, Lq0/z;->h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lq0/y;->b(Lp0/h;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lq0/z;->h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0}, Lq0/z;->e(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p0}, Lq0/z;->f(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static i(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lq0/z;->j(Ljava/util/Map;)Ljava/util/Map;
