...
# static fields
.field public static final b:La1/c$a;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, La1/c$a;-><init>(La1/e;)V

    sput-object v0, La1/c;->b:La1/c$a;
    ...
    const-class v5, Lz0/q;

    aput-object v5, v0, v2

    const/4 v2, 0x4

    const-class v5, Lz0/r;

    aput-object v5, v0, v2

    const/4 v2, 0x5

    const-class v5, Lz0/s;

    aput-object v5, v0, v2

    const/4 v2, 0x6

    const-class v5, Lz0/t;

    aput-object v5, v0, v2

    const/4 v2, 0x7

    const-class v5, Lz0/u;

    aput-object v5, v0, v2

    const/16 v2, 0x8

    const-class v5, Lz0/v;

    aput-object v5, v0, v2

    const/16 v2, 0x9

    const-class v5, Lz0/w;
    ...
    const-class v6, Lz0/e;

    aput-object v6, v0, v2

    const/16 v2, 0xe

    const-class v6, Lz0/f;

    aput-object v6, v0, v2

    const/16 v2, 0xf

    const-class v6, Lz0/g;
    ...
    const-class v6, Lz0/i;

    aput-object v6, v0, v2

    const/16 v2, 0x12

    const-class v6, Lz0/j;

    aput-object v6, v0, v2

    const/16 v2, 0x13

    const-class v6, Lz0/k;

    aput-object v6, v0, v2

    const/16 v2, 0x14

    const-class v6, Lz0/m;
    ...
    const-class v6, Lz0/o;

    aput-object v6, v0, v2

    invoke-static {v0}, Lq0/g;->c([Ljava/lang/Object;)Ljava/util/List;

    move-result-object v0

    new-instance v2, Ljava/util/ArrayList;

    invoke-static {v0, v5}, Lq0/g;->f(Ljava/lang/Iterable;I)I
    ...
    invoke-static {v5, v3}, Lp0/l;->a(Ljava/lang/Object;Ljava/lang/Object;)Lp0/h;
    ...
    :cond_1
    invoke-static {v2}, Lq0/w;->g(Ljava/lang/Iterable;)Ljava/util/Map;

    move-result-object v0

    sput-object v0, La1/c;->c:Ljava/util/Map;
    ...
    sput-object v0, La1/c;->d:Ljava/util/HashMap;
    ...
    sput-object v2, La1/c;->e:Ljava/util/HashMap;
    ...
    invoke-static {v0, v2}, La1/g;->d(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v2, v7}, La1/g;->d(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-static {v2, v5, v1, v4, v1}, Lg1/c;->u(Ljava/lang/String;CLjava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v5, v2}, Lp0/l;->a(Ljava/lang/Object;Ljava/lang/Object;)Lp0/h;

    move-result-object v2

    invoke-virtual {v2}, Lp0/h;->c()Ljava/lang/Object;

    move-result-object v5

    invoke-virtual {v2}, Lp0/h;->d()Ljava/lang/Object;
    ...
    :cond_2
    sget-object v0, La1/c;->c:Ljava/util/Map;
    ...
    :cond_3
    sput-object v3, La1/c;->f:Ljava/util/HashMap;
    ...
    invoke-static {v3, v5, v1, v4, v1}, Lg1/c;->u(Ljava/lang/String;CLjava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
    ...
    :cond_4
    sput-object v0, La1/c;->g:Ljava/util/Map;
...
.method public constructor <init>(Ljava/lang/Class;)V
    ...
    iput-object p1, p0, La1/c;->a:Ljava/lang/Class;
...
.method public a()Ljava/lang/Class;
    ...
    iget-object v0, p0, La1/c;->a:Ljava/lang/Class;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-static {p0}, Ly0/a;->b(Le1/b;)Ljava/lang/Class;

    move-result-object v0

    check-cast p1, Le1/b;

    invoke-static {p1}, Ly0/a;->b(Le1/b;)Ljava/lang/Class;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, La1/c;->a()Ljava/lang/Class;
