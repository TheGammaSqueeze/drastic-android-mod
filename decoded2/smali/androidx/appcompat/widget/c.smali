...
.method static synthetic t(Landroidx/appcompat/widget/c;)Landroidx/appcompat/view/menu/s;
    .locals 0

    iget-object p0, p0, Landroidx/appcompat/view/menu/b;->m:Landroidx/appcompat/view/menu/s;
...
.method static synthetic x(Landroidx/appcompat/widget/c;)Landroidx/appcompat/view/menu/s;
    .locals 0
...
.method private z(Landroid/view/MenuItem;)Landroid/view/View;
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/b;->m:Landroidx/appcompat/view/menu/s;
    ...
    instance-of v5, v4, Landroidx/appcompat/view/menu/s$a;

    if-eqz v5, :cond_1

    move-object v5, v4

    check-cast v5, Landroidx/appcompat/view/menu/s$a;

    invoke-interface {v5}, Landroidx/appcompat/view/menu/s$a;->getItemData()Landroidx/appcompat/view/menu/i;
...
.method public B()Z
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/b;->m:Landroidx/appcompat/view/menu/s;
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/p;->b()V
...
.method public H(Landroidx/appcompat/widget/ActionMenuView;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/b;->m:Landroidx/appcompat/view/menu/s;
...
.method public K()Z
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->m:Landroidx/appcompat/view/menu/s;
...
.method public d(Landroidx/appcompat/view/menu/i;Landroidx/appcompat/view/menu/s$a;)V
    .locals 1

    const/4 v0, 0x0

    invoke-interface {p2, p1, v0}, Landroidx/appcompat/view/menu/s$a;->d(Landroidx/appcompat/view/menu/i;I)V

    iget-object p1, p0, Landroidx/appcompat/view/menu/b;->m:Landroidx/appcompat/view/menu/s;
...
.method public e(Landroidx/appcompat/view/menu/w;)Z
    ...
    :goto_0
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/w;->e0()Landroid/view/Menu;
    ...
    :cond_1
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/w;->getItem()Landroid/view/MenuItem;
    ...
    :cond_2
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/w;->getItem()Landroid/view/MenuItem;
    ...
    invoke-direct {v2, p0, v3, p1, v0}, Landroidx/appcompat/widget/c$a;-><init>(Landroidx/appcompat/widget/c;Landroid/content/Context;Landroidx/appcompat/view/menu/w;Landroid/view/View;)V

    iput-object v2, p0, Landroidx/appcompat/widget/c;->D:Landroidx/appcompat/widget/c$a;

    invoke-virtual {v2, v1}, Landroidx/appcompat/view/menu/p;->g(Z)V

    iget-object v0, p0, Landroidx/appcompat/widget/c;->D:Landroidx/appcompat/widget/c$a;

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/p;->k()V

    invoke-super {p0, p1}, Landroidx/appcompat/view/menu/b;->e(Landroidx/appcompat/view/menu/w;)Z
...
.method public f(Z)V
    ...
    invoke-virtual {v3}, Landroidx/appcompat/view/menu/i;->b()Landroidx/core/view/d;

    move-result-object v3

    if-eqz v3, :cond_0

    invoke-virtual {v3, p0}, Landroidx/core/view/d;->i(Landroidx/core/view/d$a;)V
...
.method public h()Z
    ...
    iget-object v8, v0, Landroidx/appcompat/view/menu/b;->m:Landroidx/appcompat/view/menu/s;
...
.method public o(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/s;
    .locals 1

    iget-object v0, p0, Landroidx/appcompat/view/menu/b;->m:Landroidx/appcompat/view/menu/s;

    invoke-super {p0, p1}, Landroidx/appcompat/view/menu/b;->o(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/s;
